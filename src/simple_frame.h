...
public:
    MySimpleFrame(int _width = 800, int _height = 600) {
        ...
        onDraw() = [&](visage::Canvas& canvas) {
            ...
            // // Draw Previous button text using direct math
            // visage::Font buttonFont(static_cast<int>(m_height * 0.025), visage::fonts::Lato_Regular_ttf);
            // canvas.text("Previous", buttonFont, visage::Font::Justification::kCenter,
            //             m_width * 0.1f,    // x: marginLeft
            //             m_height * 0.9f,   // y: marginTop
            //             m_width * 0.1f,    // width
            //             m_height * 0.05f); // height

            // // Draw Next button text using direct math
            // canvas.text("Next", buttonFont, visage::Font::Justification::kCenter,
            //             m_width * 0.4f,    // x: marginLeft
            //             m_height * 0.9f,   // y: marginTop
            //             m_width * 0.1f,    // width
            //             m_height * 0.05f); // height
        };
